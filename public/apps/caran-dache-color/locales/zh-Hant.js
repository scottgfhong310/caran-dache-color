...
I18n.register('zh-Hant', {
  ...
  'tool.sets': '系列收錄對照（另開分頁）',
  'sets.title': 'Caran d’Ache 系列收錄對照',
  'sets.sub': '選一條系列 → 只留下它有出的色 → 橫向看其他系列有沒有涵蓋',
  'sets.legend': '＊ 格子裡是該系列自己的顏色——同一個正典色碼跨系列並不是同一個顏色。點格子複製該系列的 hex',
  'sets.back': '回色票頁',
  'sets.pickHint': '點欄位下方的色數，就只留下該系列有出的色',
  'sets.showingN': '{n} 色',
  'sets.clear': '清除選擇',
  'sets.rowSeries': '系列',
  'sets.rowGrade': '等級',
  'sets.colColour': '色',
  'sets.gapRow': '相對基準系列還缺幾色',
  'sets.gapSelf': '基準系列本身',
  'sets.gapTip': '相對基準系列，這一欄還缺 {n} 色',
  'sets.foot': '{rows} 個正典色碼 × {cols} 條系列；目前顯示 {shown} 列',
